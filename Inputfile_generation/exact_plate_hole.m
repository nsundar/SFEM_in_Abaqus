function [exact_stress,displace] = exact_plate_hole(pt,a,StressState,E,nu)
...
displace(1) = fac*( r/a*(k+1)*c1t + fac2*( (k+1)*c1t + c3t ) - fac1*c3t );
displace(2) = fac*( r/a*(k-3)*s1t + fac2*( (1-k)*s1t + s3t ) - fac1*s3t );
end
